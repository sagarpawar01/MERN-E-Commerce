...
const createOrder = asyncHandler(async (req,res) => {
    try {
        ...
        const dbOrderItems = orderItems.map(itemsFromClient => {
            const matchingItemFromDB = itemsFromDB.find(itemsFromDB => itemsFromDB._id.toString() === itemsFromClient._id)
...
const markOrdersAsPaid = asyncHandler(async (req,res) => {
    try {
...
export { createOrder, getAllOrders, getUserOrders, countTotalOrders, calculateTotalSales, calculateTotalSalesByDate, findOrderById, markOrdersAsPaid, markOrderAsDelivered, logoutCurrentUser, getCurrentUserProfile, updateCurrentUserProfile, deleteUserById, updateUserById }